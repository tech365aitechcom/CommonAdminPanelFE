...
const SelectDevice = () => {
  ...
  const [isModelDeleteConfirmOpen, setIsModelDeleteConfirmOpen] =
    useState(false)
  ...
  const handleTransfer = async () => {
    ...
    try {
      setIsTableLoaded(true)
      await axios.post(
        `${import.meta.env.VITE_REACT_APP_ENDPOINT}/api/transfer/transferBrandModels`,
        {
          categoryCode: Device,
          brandId,
          modelIds: modelIds,
  ...
  const handleActivate = async () => {
    ...
    try {
      setIsTableLoaded(true)
      await axios.post(
        `${import.meta.env.VITE_REACT_APP_ENDPOINT}/api/transfer/activateCategoryBrandModels`,
        {
          categoryCode: Device,
          brandId,
          modelIds: modelIds,
  ...
  return (
    <div className='flex flex-col min-h-screen pb-16 bg-white'>
      ...
      >
        ...
        <div className='font-medium text-sm text-white px-4 py-2 bg-primary rounded-full shadow shadow-primary'>
        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
          <div className='bg-white rounded-lg p-6 shadow-lg w-80'>
            ...
            <p className='text-sm text-gray-600 mb-6 text-center'>
              Are you sure you want to delete {selectedModels.length} model(s)?
